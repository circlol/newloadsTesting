...
$pfxPath = "C:\Users\Circlol\New Loads.pfx"
$pfxPassword = ConvertTo-SecureString -String "banana123" -Force -AsPlainText

# Load the PFX file into a variable
$pfxCert = New-Object System.Security.Cryptography.X509Certificates.X509Certificate2
$pfxCert.Import($pfxPath, $pfxPassword, [System.Security.Cryptography.X509Certificates.X509KeyStorageFlags]::DefaultKeySet)

# Use the certificate to sign PowerShell scripts
$Scripts = Get-ChildItem -Recurse -Include "*.ps*1"
ForEach ($Script in $Scripts){
    Set-AuthenticodeSignature $Script $pfxCert
}
Read-Host
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUxGhZ8BQEuSYXK4S39p0KaQOF
# 37qgggZWMIIGUjCCBDqgAwIBAgIQIs9ET5TBkYlFoLQHAUEE/jANBgkqhkiG9w0B
...
# DAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU5+5tm1vuDi4UOnZtt2xqGCiw
# SeowDQYJKoZIhvcNAQEBBQAEggIAhRYQsj7CR03bEuk9ZxOIgh0KbqDNPGv81XDm
# fHpw2YMPaNUkTruM2sM21tXBZ6dMTMRmmmWSjZMKWotghn19APePUmy4kx01DE8a
# fXNdWKGoPPWV+vAazz6KuY4fBGZo6fRdI+SizuSvMJRX7P1+aAU4sF1hFksbW1gr
# c6UKNBtRGOikIF/TD55nskVMOg/9mrQzsrVxNzkoUyvzk72W0bGiJ60h3+/U8J1E
# hsU6sKBnvOSlwx+2PzkxRgck2JGKgrA/eZW09GwDr0zPj2u+QOg3S1bCNPU4tunD
# zPe1aw4vXIVMCu7/aeiYwmS9JnciKt3UTYYy8zsMTp9M0MQdAgfVN/wBVdodifO2
# PIsAHqR6HA5AF+stLcxn4dLjeH5WNJxAKtBiyMgwv8KDtQeQrObJgK4A+pKnafXe
# NBXrRAk5NFyiPdX55k3keRLgKpgHZb8+/yBt+cK6aQG3EzrgLDOdgv75ESL+WZS1
# mQQnQqYw5jgd3/JrVAeWchkTRtqIxQ3cDmHVmHfDWSomIjfzxPxCj/8/ygN7xkim
# AQACw2BezvZXeu2ZHJCeMdNwoiMzrfeOy8Ny57EGyQYa8aj8Y1uR6d8saJxk13g7
# 82VrwUQ0kj8wMwWk3iKGlAQXzvBXvXtXUhCh094abX/X4KQ1CMZ2uRPJD+/6KvqS
# atX/jJg=
